...
{ geo:“ის”,      meg:“თინა”,     tr:”[tʰina]”,            ru:“он / она”,     en:“he / she”,     topic:“pronouns” },
{ geo:“ჩვენ”,    meg:“ჩქი”,      tr:”[tʃʰki]”,            ru:“мы”,           en:“we”,           topic:“pronouns” },
{ geo:“თქვენ”,   meg:“თქვა”,     tr:”[tʰkva]”,            ru:“вы”,           en:“you (pl.)”,    topic:“pronouns” },
{ geo:“ისინი”,   meg:“თინეფი”,   tr:”[tʰinepi]”,          ru:“они”,          en:“they”,         topic:“pronouns” },

// ── ПРИВЕТСТВИЯ ─────────────────────────────────────────────────────────
{ geo:“გამარჯობა”,  meg:“გომორძგუა”,  tr:”[ɡomorzɡua]”,   ru:“здравствуй”,  en:“hello”,       topic:“greetings” },
{ geo:“მადლობა”,    meg:“მარდობა”,    tr:”[mardoba]”,      ru:“спасибо”,     en:“thank you”,   topic:“greetings” },
{ geo:“ბოდიში”,     meg:“ბოდიში”,     tr:”[bodiʃi]”,       ru:“извините”,    en:“excuse me”,   topic:“greetings” },

// ── СЕМЬЯ ───────────────────────────────────────────────────────────────
{ geo:“ოჯახი”,       meg:“მახორობა”,   tr:”[maxoroba]”,     ru:“семья”,                    en:“family”,                   topic:“family” },
{ geo:“დედა”,        meg:“დიდა”,       tr:”[dida]”,         ru:“мать”,                     en:“mother”,                   topic:“family” },
{ geo:“მამა”,        meg:“მუმა”,       tr:”[muma]”,         ru:“отец”,                     en:“father”,                   topic:“family” },
{ geo:“ძმა”,         meg:“ჯიმა”,       tr:”[dʒima]”,        ru:“брат”,                     en:“brother”,                  topic:“family” },
{ geo:“და”,          meg:“და”,         tr:”[da]”,           ru:“сестра”,                   en:“sister”,                   topic:“family” },
{ geo:“შვილი”,       meg:“სკუა”,       tr:”[skua]”,         ru:“ребёнок, дитя”,            en:“child”,                    topic:“family” },
{ geo:“ვაჟი”,        meg:“ბოში”,       tr:”[boʃi]”,         ru:“сын”,                      en:“son”,                      topic:“family” },
{ geo:“ქალიშვილი”,   meg:“ოსურსკუა”,  tr:”[osurskua]”,     ru:“дочь”,                     en:“daughter”,                 topic:“family” },
{ geo:“შვილიშვილი”,  meg:“მოთა”,       tr:”[motʰa]”,        ru:“внук / внучка”,            en:“grandchild”,               topic:“family” },
...
{ geo:“ბიძა”,        meg:“ჯიმადი”,     tr:”[dʒimadi]”,      ru:“дядя”,                     en:“uncle”,                    topic:“family” },
...
{ geo:“ქმარი”,       meg:“ქომონჯი”,     tr:”[kʰomondʒi]”,    ru:“муж”,                      en:“husband”,                  topic:“family” },
{ geo:“ცოლი”,        meg:“ოსური”,      tr:”[osuri]”,        ru:“жена”,                     en:“wife”,                     topic:“family” },
{ geo:“დედამთილი”,   meg:“დიანთილი”,   tr:”[diantʰili]”,   ru:“свекровь”,                 en:“mother-in-law”,            topic:“family” },
{ geo:“მამამთილი”,   meg:“მუანთილი”,   tr:”[muantʰili]”,   ru:“свёкор”,                   en:“father-in-law”,            topic:“family” },
{ geo:“ნათესავი”,    meg:“ნათესე”,     tr:”[natʰese]”,      ru:“родственник”,              en:“relative”,                 topic:“family” },

// ── ПРИРОДА ─────────────────────────────────────────────────────────────
{ geo:“ბალახი”,  meg:“ოდიარე”,    tr:”[odiare]”,       ru:“трава”,        en:“grass”,        topic:“nature” },
{ geo:“ქარი”,    meg:“ბორია”,    tr:”[boria]”,       ru:“ветер”,        en:“wind”,         topic:“nature” },
{ geo:“ხანძარი”, meg:“დაჩხირი”,   tr:”[datʃxiri]”,      ru:“огонь, пожар”, en:“fire”,         topic:“nature” },
{ geo:“ქვა”,     meg:“ქუა”,       tr:”[kʰua]”,         ru:“камень”,       en:“stone”,        topic:“nature” },
{ geo:“ბალი”,    meg:“ბული”,      tr:”[buli]”,         ru:“черешня”,        en:“cherry”,       topic:“nature” },

// ── ЖИВОТНЫЕ ────────────────────────────────────────────────────────────
{ geo:“ქათამი”,  meg:“ქოთომი”,    tr:”[kʰotʰomi]”,    ru:“курица”,       en:“hen”,          topic:“animals” },
{ geo:“ხარი”,    meg:“ხოჯი”,      tr:”[xodʒi]”,        ru:“бык”,          en:“bull”,         topic:“animals” },
{ geo:“ვირი”,    meg:“გირინი”,    tr:”[ɡirini]”,       ru:“осёл”,         en:“donkey”,       topic:“animals” },

// ── ЕДА ─────────────────────────────────────────────────────────────────
{ geo:“პური”,    meg:“ქობალი”,    tr:”[kʰobali]”,      ru:“хлеб”,         en:“bread”,        topic:“food” },
{ geo:“სადილი”,  meg:“სადილი”,    tr:”[sadili]”,       ru:“обед”,         en:“dinner”,       topic:“food” },

// ── ГОРОД И ОБЩЕСТВО ────────────────────────────────────────────────────
{ geo:“ადამიანი”, meg:“კოჩი”,  tr:”[kotʃi]”,    ru:“человек”,      en:“human”,        topic:“society” },
{ geo:“ხალხი”,    meg:“ხარხი”,     tr:”[xarxi]”,       ru:“народ, люди”,  en:“people”,       topic:“society” },
{ geo:“ქალაქი”,   meg:“ნოღა”,      tr:”[noɣa]”,        ru:“город”,        en:“city”,         topic:“society” },
{ geo:“სოფელი”,   meg:“სოფელი”,    tr:”[sopeli]”,      ru:“село”,         en:“village”,      topic:“society” },
{ geo:“ქვეყანა”,  meg:“ქიანა”,     tr:”[kʰiana]”,      ru:“страна”,       en:“country”,      topic:“society” },
{ geo:“სახლი”,    meg:“ჸუდე”,       tr:”[ʔude]”,         ru:“дом”,          en:“house”,        topic:“society” },

// ── ВРЕМЯ И МЕСТО ───────────────────────────────────────────────────────
{ geo:“ადგილი”,  meg:“არდგილი”,   tr:”[ardɡili]”,     ru:“место”,        en:“place”,        topic:“time_place” },
{ geo:“სად”,     meg:“სო”,        tr:”[so]”,          ru:“где”,          en:“where”,        topic:“time_place” },
{ geo:“საათი”,   meg:“სათი”,      tr:”[satʰi]”,       ru:“час, часы”,    en:“hour, clock”,  topic:“time_place” },
{ geo:“ადრე”,    meg:“ადრე”,      tr:”[adre]”,        ru:“рано”,         en:“early”,        topic:“time_place” },

// ── ЯЗЫК И ОБЩЕНИЕ ──────────────────────────────────────────────────────
{ geo:“ენა”,      meg:“ნინა”,     tr:”[nina]”,        ru:“язык”,         en:“language”,     topic:“language” },
{ geo:“სახელი”,   meg:“სახელი”,   tr:”[saxeli]”,      ru:“имя”,          en:“name”,         topic:“language” },
{ geo:“გვარი”,    meg:“გვარი”,    tr:”[ɡvari]”,       ru:“фамилия”,      en:“surname”,      topic:“language” },
{ geo:“სწავლა”,   meg:“გურაფა”,   tr:”[ɡurapʰa]”,     ru:“учёба”,        en:“study”,        topic:“language” },
];
