...
//
// Транслитерация (строго по таблице):
...
// ВАЖНО: კ=ḳ (с точкой), ქ=k (без точки) — разные буквы!
...
const NEW_WORDS = [
  ...
  {meg:"ჩხომი",        tr:"čxomi",        geo:"თევზი",                       ru:"рыба",                                en:"fish"},
...
// ── НОВЫЕ СЛОВА — вставить в DICT перед финальным ]; ────────────────────────
